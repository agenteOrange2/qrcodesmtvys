<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <!-- Mostrar el enlace Dashboard solo si el usuario tiene el permiso 'Dashboard' -->
                    @can('dashboard')
                    ...
                    <!-- Mostrar el enlace Usuarios solo si el usuario tiene el permiso 'users' -->
                    @can('users')
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Mostrar el enlace Scan solo si el usuario tiene el permiso 'scan' -->
            @can('scan')
                <x-responsive-nav-link href="{{ route('admin.scan') }}" :active="request()->routeIs('admin.scanner.scan')">
                    {{ __('Scan') }}
                </x-responsive-nav-link>
            @endcan
