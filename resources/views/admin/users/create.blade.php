        ...
        <div class="max-w-7xl mx-auto sm:px-6 px-8 py-6 bg-white ">
            ...
            <form>
                ...
                <div class="bg-white p-6 rounded-lg mb-6 w-full max-w-lg">
                    <div class="mb-4">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600" for="file_input">Upload file</label>
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2">Assign Role</label>
                        <div class="flex items-center mb-2">
                            <input id="admin" name="role" type="radio"
                                class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                            <label for="admin" class="ml-2 block text-sm text-gray-700">Administrator</label>
                        </div>
                        <div class="flex items-center mb-2">
                            <input id="member" name="role" type="radio"
                                class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                            <label for="member" class="ml-2 block text-sm text-gray-700">Member</label>
                        </div>
                        <div class="flex items-center">
                            <input id="viewer" name="role" type="radio" checked
                                class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                            <label for="viewer" class="ml-2 block text-sm text-gray-700">Viewer</label>
                        </div>
                    </div>
